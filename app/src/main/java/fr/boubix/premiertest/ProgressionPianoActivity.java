...
public class ProgressionPianoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progression_piano);

        view = this.getWindow().getDecorView();
        MediaPlayer back_sound = MediaPlayer.create(this, R.raw.back_sound);
        text = (TextView) findViewById(R.id.progression_text_piano);
        back_button = (ImageView) findViewById(R.id.button_back_progression_piano);

        setOption();
        getSaveGame();
        setGraph();

        ImageView back = (ImageView) findViewById(R.id.button_back_progression_piano);
    ...
    private void setGraph(){
        ...
        graph = (GraphView) findViewById(R.id.graph_piano);
    ...
    private void getSaveGame(){
        ...
        file  = new File(path, "save_game_piano_tiles_" + String.valueOf(counterTime) + ".txt");
        try {
