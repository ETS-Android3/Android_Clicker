...
public class ProgressionClickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progression_clicker);

        view = this.getWindow().getDecorView();
        MediaPlayer back_sound = MediaPlayer.create(this, R.raw.back_sound);
        text = (TextView) findViewById(R.id.progression_text_clicker);
        back_button = (ImageView) findViewById(R.id.button_back_progression_clicker);

        setOption();
        getSaveGame();
        setGraph();

        ImageView back = (ImageView) findViewById(R.id.button_back_progression_clicker);
    ...
    private void setGraph(){
        ...
        graph = (GraphView) findViewById(R.id.graph_clicker);
    ...
    private void getSaveGame(){
        ...
        file  = new File(path, "save_game_clicker_" + String.valueOf(counterTime) + ".txt");
        try {
