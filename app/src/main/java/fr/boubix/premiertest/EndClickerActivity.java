...
public class EndClickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_end_clicker);

        MediaPlayer clicButton = MediaPlayer.create(this, R.raw.button_sound);
        textScore = (TextView) findViewById(R.id.score_clicker);
        view = this.getWindow().getDecorView();
        score = (TextView) findViewById(R.id.number_of_points_clicker);
        percent = (TextView) findViewById(R.id.percent_display_clicker);
        ...
        Button button = (Button) findViewById(R.id.menu_principal_clicker);
